...
export default function GameCard({ game }) {
  return (
    ...
    >
      ...
      <div className="p-3">
        <h3 className="font-display text-lg leading-tight text-zinc-900 dark:text-zinc-100 group-hover:text-brand-600 dark:group-hover:text-brand-300 transition-colors line-clamp-2">
          {game.title}
        </h3>
